                  ...
                  <table class="table">
                    <thead class="table-head">
                      <tr>
                        ...
                        <th width="20%">Bet Amount</th>
                        <th width="15%">Multiplier</th>
                        <th width="15%" class="text-end">Profit Amount</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="text-white">img/table-avatar1.svg</td>
                        <td class="text-white">
                          104.54 <img class="ms-1" src="img/mft.svg" />
                        </td>
                        <td>0.001x</td>
                      ...
                      <tr>
                        <td>
                          <img class="me-1" src="img/dice.svg" /> Ring of
                          fortune
                        </td>
                        <td class="text-white">BranyW67</td>
                        <td class="text-white">
