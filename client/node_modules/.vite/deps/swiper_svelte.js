import {
  core_default
} from "./chunk-5U6YIL7F.js";
import "./chunk-FHQ6GQKG.js";
import "./chunk-FUITXIMN.js";
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 166, 4, 4554);
      attr_dev(div1, "class", "swiper-button-next");
      add_location(div1, file, 167, 4, 4613);
    },
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 170, 4, 4719);
    },
    m: function mount(target, anchor) {
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 173, 4, 4829);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      ctx[18](div);
...
function create_dynamic_element(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svelte_element0, file, 160, 2, 4335);
      set_dynamic_element_data(
        /*tag*/
        ctx[1]
      )(svelte_element1, svelte_element_data_1);
      add_location(svelte_element1, file, 153, 0, 4139);
    },
    m: function mount(target, anchor) {
...
function create_if_block2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file2, 85, 4, 2211);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (default_slot) {
...
function create_fragment2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file2, 78, 0, 2020);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
