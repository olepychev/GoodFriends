import { r as onMount, o as onDestroy } from './index2-3ef52108.js';
import { w as writable } from './index-b71c747f.js';
...
function observe$1(defaultValue) {
...
function getObserver$1(instance, name, defaultValue) {
  ...
  if (!observers[name]) {
    observers[name] = observe$1(defaultValue);
  }

  return observers[name];
}

function injectReactiveSubscribe$1(object) {
...
function ReactiveSubscribe$1(Constructor) {
  ...
  injectReactiveSubscribe$1(prototype);
}
...
var setCssProps = function (element, option, direction) {
  ...
  if (element && element.style) {
    ...
    var newCssProps_1 = __assign$3(__assign$3({}, PREVENT_DRAG_CSSPROPS), {
...
function () {
  ...
  __proto.triggerRelease = function (param) {
    ...
    this._axes.trigger(new ComponentEvent$1("release", __assign$3(__assign$3({}, param), {
  ...
  __proto.triggerChange = function (pos, depaPos, option, holding) {
    ...
    Object.keys(moveTo.pos).forEach(function (axis) {
      ...
      getObserver$1(_this._axes, axis, p).current = p;
    });
  ...
  __proto._createUserControll = function (pos, duration) {
    ...
    var userControl = {
      destPos: __assign$3({}, pos),
      duration: duration
    };
    return function (toPos, userDuration) {
      if (toPos) {
        userControl.destPos = __assign$3({}, toPos);
      }
...
function () {
  ...
  __proto.get = function (axes) {
    ...
    if (axes && Array.isArray(axes)) {
      ...
      return __assign$3(__assign$3({}, this._pos), axes || {});
    }
  };
  ...
  __proto.setAxis = function (axis) {
    ...
    Object.keys(axis).forEach(function (key) {
      ...
      _this._axis[key] = __assign$3(__assign$3({}, _this._axis[key]), axis[key]);
    });
...
function () {
  ...
  __proto.animateTo = function (destPos, duration, option) {
    ...
    var depaPos = __assign$3({}, param.depaPos);
  ...
  __proto._animateLoop = function (param, complete) {
    ...
    if (param.duration) {
      this._animateParam = __assign$3(__assign$3({}, param), {
...
function (_super) {
  ...
  __proto.setOptions = function (options) {
    this.options = __assign$3(__assign$3({}, this.options), options);
    return this;
  };
  /**
  ...
  Axes = __decorate$1([ReactiveSubscribe$1], Axes);
  return Axes;
}(Component);
...
function adaptReactive(adapter, props) {
  ...
  var emit = function (eventName) {
    ...
    eventEmitter.trigger.apply(eventEmitter, __spreadArray$1([eventName], params, false));
  };
    ...
    init: function () {
      ...
      offHooksList = eventNames.map(function (eventName) {
        var listener = function () {
          ...
          (_a = eventEmitter).trigger.apply(_a, __spreadArray$1([eventName], params, false));
        };
...
function (_super) {
  ...
  __proto.init = function () {
    ...
    axes.on({
      ...
      "release": function (e) {
        if (!isDrag) {
          e.setTo(__assign$2({}, e.depaPos), 0);
...
var REACTIVE_CONVEYER = {
  ...
  created: function (data) {
    return new Conveyer(data.container, __assign$2(__assign$2({}, data.props), {
      autoInit: false
    }));
  },
...
export { useConveyer as u };
//# sourceMappingURL=conveyer.esm-2bde14fd.js.map
