<script>
  ...
  async function handleMyProfile(event) {
    ...
    const permanentFile = await saveImageWebp({
    ...
    <div class="userinformation">
        ...
        <div class="col-md-8 col-7 align-self-center">
          {#if $globalStore.userInfo.owner}
            {#if !$globalStore.userInfo.editState}
              <h4 class="mb-0 gradient-text gradient-text-light2">
                My Profile
              </h4>
            {:else}
              <div class="profile_title d-flex gap-15">
                <svg
                  class="profile_back cursor-pointer"
                  on:click={() => {
      ...
      {#if !$globalStore.userInfo.editState}
          ...
          <div class="col-md-12 text-center">
            <div class="position-relative">
              <div class="userback">
                <img
                  class="userimg"
                  src={$globalStore.userInfo.profile_image}
                />
              </div>
            ...
            <div class="position-relative">
              <h6
                class="text-white mb-2 mt-3 gradient-text gradient-text-light2"
              >
                {$globalStore.userInfo.nick}
              </h6>
        ...
        <div class="row">
          <div class="col-md-4 col-4">
            <div class="wins text-center bg2 box-style p-20 w-100">
        ...
        <div class="heading mt-4">
          <h5 class="statistic-widget-title">
            <svg><use href="/img/symbols.svg?lang.svg#icon_favorite" /></svg> Top
            3 Favorite Games
          </h5>
        </div>
        <div class="row">
      ...
      {:else}
        <form on:submit={handleMyProfile}>
          ...
          <div class="heading mt-4">
            <h5 class="statistic-widget-title">Default Images</h5>
          </div>
          <div class="row">
          ...
          <div class="heading mt-4">
            <h5 class="statistic-widget-title">Edit Nickname</h5>
          </div>
          <div class="row">
