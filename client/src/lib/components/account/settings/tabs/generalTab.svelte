...
<div class="w-full">
	...
	<div class="w-full flex flex-col pb-[25px] border-b border-grayLight dark:border-white11">
		<p class="text-sm sm:text-base text-black dark:text-white font-medium mt-[25px] mb-[20px]">Fiat Currency</p>
	...
	<div class="flex flex-col mt-[19px] pb-[25px] border-b border-b-grayLight dark:border-b-white11">
		<p class="text-sm sm:text-base text-black dark:text-white font-medium mt-[25px] mb-[20px]">Theme</p>
		<div
	...
	<div class="w-full flex flex-col pb-[25px] border-b border-grayLight dark:border-white11">
		<p class="text-sm sm:text-base text-black dark:text-white font-medium mt-[25px] mb-[20px]">Language</p>
