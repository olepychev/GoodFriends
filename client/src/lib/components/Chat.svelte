...
<div class="position-relative">
  <div class="right-bar chat">
    <div class="chattable table-black hide-scrollbar">
      <table class="table table-borderless">
            ...
            <th>
              <div class="text-end icon">
                ...
                <a href="#" id="cancel" on:click={closeChat}>
                  ...
                  <img class="whiteicon d-none" src="/img/Cancel-white.svg" />
                </a>
              </div>
            </th>
          </tr>
        ...
        <tbody>
          <tr>
            <th width="15%"
              ><img on:click={openUserModal} src="/img/user1.svg" /></th
            >
            <td colspan="2">
              <p class="mb-2">
                <span class="name" on:click={openUserModal}
                  >Ellis Schneidera <img src="/img/Group-1581.svg" />
