...
<div class="sidebar-lg left-side-bar bg-color {pageSidebar}">
  <button
    id="lefbutton"
    class="btn btn-color text-white toggle-sidebar-btn p-5"
    on:click={toggleSidebar}
  >
    <svg id="smoll_menu"
      ><use href="/img/symbols.svg?lang.svg#icon_arrow_left" />
    </svg>
    <img id="closed_menu" src="/img/close.svg" />
  </button>
  <div class="pe-4 pt-3 ps-4">
    <div class="logo pt-10 pb-30">
      <a href="/">
  ...
  <div class="scroll">
    {#if !isSportsPage}
      ...
      <div class="border" />
      <ul class="menu menu1">
        <li class="my-15" class:active={pageSidebar === "/favourites"}>
          <a
            href="/favourites"
            class="menu-item-icon position-relative"
            class:active={pageSidebar === "/favourites"}
          >
            <div class="icon-bg">
              <svg
                ><use
                  href="/img/symbols.svg?lang.svg#icon_side_favorite"
                /></svg
              >
            </div>
    ...
    {:else}
      ...
      <ul class="menu menu1">
        <li class="my-15">
          <a href="favourites.php"
            ><img
              class="me-3 icon1 icon_hide"
              src="/img/Icon_nav_football.svg"
            />
            <img
              class="me-3 icon1 icon-hover"
              src="/img/Icon_nav_football-white.svg"
            />
        ...
        <li class="my-15">
          <a href="#"
            ><img
              class="me-3 icon1 icon_hide"
              src="/img/Icon_nav_american-football.svg"
            />
            <img
              class="me-3 icon1 icon-hover"
              src="/img/Icon_nav_american-football-white.svg"
            />
      ...
      <div class="sportb mobilenone mt-3 favourites">
        <div class="input-group mb-3">
          <button type="button" class="btn btn-search px-15">
        ...
        <div class="language-widget-wrapper language-dt">
          ...
          >
            <div slot="prepend">
              <svg
                ><use
                  href="/img/symbols.svg?lang.svg#icon_side_language"
                /></svg
              >
            </div>
          </Select>
...
<div class="sidebar-sm left-side-bar bg-color {pageSidebar}">
  <button
    id="lefbutton"
    class="toggle-sidebar-btn btn btn-color text-white p-5"
    on:click={toggleSidebar}
    style="transform: rotate(180deg);"
  >
    <svg id="smoll_menu" class="mobilenone"
      ><use href="/img/symbols.svg?lang.svg#icon_arrow_left" />
    </svg>
    <img id="closed_menu" src="/img/close.svg" />
  </button>
    ...
    <div class="pb-3">
      <div class="language">
        <div class="language-mb">
          <div
            class="mb-active-lang"
            on:click={() => (mobileOptions = !mobileOptions)}
          >
            <span>EN</span>
          </div>
          {#if mobileOptions}
