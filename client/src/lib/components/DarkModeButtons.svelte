<script>
  ...
  let lightMode =
    Cookies.get("Mode") == undefined ? "Dark" : Cookies.get("Mode");
</script>

<div class="row">
  <div class="col-md-6 col-6 pe-1">
    <button
      class="btn color-chnage px-15 py-10 w-100"
      class:active={lightMode === "Light"}
      on:click={() => {
        lightMode = "Light";
      }}
  ...
  <div class="col-md-6 col-6 ps-1">
    <button
      class="btn color-chnage px-15 py-10 w-100 active"
      class:active={lightMode === "Dark"}
      on:click={() => {
        lightMode = "Dark";
      }}
      on:click={disableLightMode}
    >
