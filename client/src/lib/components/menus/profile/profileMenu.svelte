...
<div id="profileModal" class="fixed translate-x-[50%] sm:translate-x-[auto] right-[50%] sm:right-[20px] w-[96%] sm:w-auto top-[80px] sm:top-[20px] z-[999999] bg-white dark:bg-black rounded-[14px] overflow-hidden border border-white11">
	<div class="relative z-[2] min-w-[300px] sm:w-auto p-[15px]">
		...
		<div class="flex flex-col gap-[12px] mt-[19px] pb-[15px] border-b border-b-white11">
			...
			<div class="w-full flex items-center justify-around bg-grayLight4 dark:bg-white5 rounded-[7px] p-[5px]">
