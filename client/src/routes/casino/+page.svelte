<script>
  ...
  const search = async () => {
    // Removed argument from function signature
...
<div class="container">
  <FaqItem>
    ...
    <div slot="details" class="faq-answer">
      <p>
        Lorem ipsum dolor sit amet consectetur. Quis rhoncus cursus magna nunc
        nam aliquet pretium varius et. Pellentesque vel ipsum purus lectus at
        enim.
      </p>
    </div>
  </FaqItem>
  ...
  <div class="boxsecond boxforth">
    ...
    <div class="minigames-btn mb-30">
      <button class="btn active me-2">All</button>
      <button class="btn me-2"> Hot </button>
    ...
    <div class="owl-minigames row" style="row-gap: 20px;">
      ...
      {:then data}
        {#each list as item}
          <div class="casino-item col-lg-2 col-sm-3 col-6 px-10">
