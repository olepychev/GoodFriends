<div class="container">
  <form action="">
    <div class="input-group mb-3 main-search-bar">
        <input type="search" class="form-control" placeholder="Search here..." aria-label="Username" aria-describedby="basic-addon1" />
        <button type="submit" class="input-group-text" id="basic-addon1"><img src="/img/Search.svg" /></button>
    </div>
  </form>  
    <div class="boxsecond boxforth">
      ...
      <div class="minigames-btn">
        ...
        <button class="btn">
          <img class="me-1" src="/img/icon_livtv-sportsve-sports.svg" /> Live
          Mini Games
        </button>
      </div>
