<div class="container">
  ...
  <div class="sports">
    <div class="box">
      <div class="sports_img position-relative sports-exapanded1">
  ...
  <div class="leagues gradient-text gradient-text-purple2 mt-3">
    <h3 class="mb-0">Top Leagues</h3>
    <p class="mb-0">
      Englad - FA Cup <span>(3)</span>
      <svg class="favorite-league float-end active"
        ><use href="/img/symbols.svg?lang.svg#icon_star" /></svg
      >
    </p>
    <p class="mb-0">
      England - Premier League Odds <span>(15)</span>
      <svg class="favorite-league float-end"
        ><use href="/img/symbols.svg?lang.svg#icon_star" /></svg
      >
    </p>
    <p class="mb-0">
